...
<form action="https://api.sheetmonkey.io/form/iQMYhHKk257VGevi81mAqL" method="post">
    ...
    <label for="ROOM" class="col-sm-8">*Room Number:</label>
    <label for="CHECK-OUT" class="col-sm-8">*Check-Out Date:</label>
    </div>
    <div class="form-group row">
    ...
    <input type="date" id="CHECK-OUT" name="CHECK-OUT" class="form-control col-sm-4" autocomplete="off" required>
    </div>
    <div class="form-group">
