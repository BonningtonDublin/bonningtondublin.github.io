<html lang="en">
  ...
  <!-- Required meta tags -->
    ...
    <script>document.getElementById("CHECK-IN").valueAsDate = new Date();</script>
  </head>
...
<form action="https://api.sheetmonkey.io/form/wTtg3wkPyv7RdnBEzrRdDY" method="post">
    ...
    <input type="date" id="CHECK-OUT" name="CHECK-OUT" class="form-control" autocomplete="off" onchange="isDateSelected()" required>
    </div>
    <div class="form-group">
